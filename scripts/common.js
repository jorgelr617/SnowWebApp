...
//Send the get full name request.
function displayUserFullname(id_val)
{
  ...
  (
    {
      type: "POST",
      url: "./php/getFullname.php",
      data: {id:id_val},
      dataType: "json",
      success: displayUserFullname_successCallback,
      error: displayUserFullname_errorCallback
    }
  );
}        

//Success get full name callback.
...
//Error get full name callback.
function displayUserFullname_errorCallback(data, status, xhr) 
{
